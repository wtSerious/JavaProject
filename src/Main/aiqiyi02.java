...
public class aiqiyi02 {
    ...
    public static void backTracing(char[][] chs, int row, int n, List<List<String>> res){
        //每行都摆满皇后时，则产生了一种解法
        if(row==n){
    ...
    public static List<String> chsToList(char[][] chs){
    ...
    public static boolean isValid(char[][] chs, int x, int y){
        for(int i=0;i<=x;i++){
